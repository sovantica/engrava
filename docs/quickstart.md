...
- [MCP server (`engrava-mcp`)](https://github.com/sovantica/engrava-mcp) — connect an MCP client (Claude Desktop, Cursor, …) to a store via the standalone server package
