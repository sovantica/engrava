...
* Merge bi-temporal valid-time storage into v0.4.0 ([534cb5c](https://github.com/sovantica/engrava/commit/534cb5c))
* Merge chore/release-trigger-to-dev: switch release-trigger to dev + align docs + CI on dev ([3ce07b2](https://github.com/sovantica/engrava/commit/3ce07b2))
* Merge convenience API (remember/recall) and cycle defaults into v0.4.0 ([bd6402f](https://github.com/sovantica/engrava/commit/bd6402f))
* Merge doc-block execution (tutorial end-to-end + search round-trip) into v0.4.0 ([c582bf0](https://github.com/sovantica/engrava/commit/c582bf0))
* Merge docs accuracy fix + documentation-example tests ([f4e1e28](https://github.com/sovantica/engrava/commit/f4e1e28))
* Merge documented-defaults verification and metadata-helper docs into v0.4.0 ([8ff4145](https://github.com/sovantica/engrava/commit/8ff4145))
* Merge embedding-input repair into v0.4.0 ([825a9fc](https://github.com/sovantica/engrava/commit/825a9fc))
* Merge embedding-provider transient-error retry into v0.4.0 ([f959844](https://github.com/sovantica/engrava/commit/f959844))
* Merge full-text query repair into v0.4.0 ([ba1b288](https://github.com/sovantica/engrava/commit/ba1b288))
* Merge MCP delete tools (delete_thought, delete_edge) into v0.4.0 ([76598bb](https://github.com/sovantica/engrava/commit/76598bb))
* Merge MCP guided memory prompts into v0.4.0 ([2afef80](https://github.com/sovantica/engrava/commit/2afef80))
* Merge MCP memory filters and pagination into v0.4.0 ([62b2b60](https://github.com/sovantica/engrava/commit/62b2b60))
* Merge MCP resources (thought, stats, recent) into v0.4.0 ([62c7639](https://github.com/sovantica/engrava/commit/62c7639))
* Merge MCP server (read tools) + MindQL execution entry point into v0.4.0 ([82c65f0](https://github.com/sovantica/engrava/commit/82c65f0))
* Merge MCP server guide and client-config examples into v0.4.0 ([7ccdbd8](https://github.com/sovantica/engrava/commit/7ccdbd8))
* Merge MCP structured tool errors into v0.4.0 ([8c6811b](https://github.com/sovantica/engrava/commit/8c6811b))
* Merge MCP write tools, read-only mode and safety annotations into v0.4.0 ([3723d10](https://github.com/sovantica/engrava/commit/3723d10))
* Merge MindQL correctness fixes into v0.4.0 ([3f3fbeb](https://github.com/sovantica/engrava/commit/3f3fbeb))
* Merge pull request #13 from sovantica/dev ([f2d4f8b](https://github.com/sovantica/engrava/commit/f2d4f8b)), closes [#13](https://github.com/sovantica/engrava/issues/13)
* Merge pull request #14 from sovantica/chore/commitlint-ignore-merge-commits ([fbfe701](https://github.com/sovantica/engrava/commit/fbfe701)), closes [#14](https://github.com/sovantica/engrava/issues/14)
* Merge pull request #15 from sovantica/dev ([f93d026](https://github.com/sovantica/engrava/commit/f93d026)), closes [#15](https://github.com/sovantica/engrava/issues/15)
* Merge pull request #18 from sovantica/dev ([3db5530](https://github.com/sovantica/engrava/commit/3db5530)), closes [#18](https://github.com/sovantica/engrava/issues/18)
* Merge pull request #21 from sovantica/dev ([f07fef4](https://github.com/sovantica/engrava/commit/f07fef4)), closes [#21](https://github.com/sovantica/engrava/issues/21)
* Merge pull request #23 from sovantica/dev ([b2f1691](https://github.com/sovantica/engrava/commit/b2f1691)), closes [#23](https://github.com/sovantica/engrava/issues/23)
* Merge pull request #27 from sovantica/release/v0.4.0 ([fcc41c1](https://github.com/sovantica/engrava/commit/fcc41c1)), closes [#27](https://github.com/sovantica/engrava/issues/27)
* Merge pull request #28 from sovantica/fix/branch-guard-semver ([0598155](https://github.com/sovantica/engrava/commit/0598155)), closes [#28](https://github.com/sovantica/engrava/issues/28)
* Merge pull request #29 from sovantica/ci/release-app-token ([5432de6](https://github.com/sovantica/engrava/commit/5432de6)), closes [#29](https://github.com/sovantica/engrava/issues/29)
* Merge pull request from dev: docs accuracy fix + documentation-example tests (WS docs) ([7d1118d](https://github.com/sovantica/engrava/commit/7d1118d))
* Merge quickstart remember()/recall() short path into v0.4.0 ([1a89476](https://github.com/sovantica/engrava/commit/1a89476))
* Merge README extras list + drop no-op dreaming extra into v0.4.0 ([13c2448](https://github.com/sovantica/engrava/commit/13c2448))
* Merge README quickstart remember()/recall() into v0.4.0 ([22bf027](https://github.com/sovantica/engrava/commit/22bf027))
* Merge reflection temporal-extent inheritance into v0.4.0 ([e220f0a](https://github.com/sovantica/engrava/commit/e220f0a))
* Merge search functional contract suite into v0.4.0 ([30027f4](https://github.com/sovantica/engrava/commit/30027f4))
* Merge session-wide test thread-pinning into v0.4.0 ([114e85a](https://github.com/sovantica/engrava/commit/114e85a))
* Merge sqlite pragma tuning and hot-path indexes into v0.4.0 ([66afaf0](https://github.com/sovantica/engrava/commit/66afaf0))
* Merge temporal query predicates and invalidate primitive into v0.4.0 ([c160736](https://github.com/sovantica/engrava/commit/c160736))
* Merge temporal-query performance gate into v0.4.0 ([4779c9c](https://github.com/sovantica/engrava/commit/4779c9c))
* ci: add secret scan + dependency audit; verify wheel data on publish (#22) ([7cfaec3](https://github.com/sovantica/engrava/commit/7cfaec3)), closes [#22](https://github.com/sovantica/engrava/issues/22)
* ci: align branch-name guard allowed types with BRANCHING.md ([a7f3e98](https://github.com/sovantica/engrava/commit/a7f3e98))
* ci: allow semantic-version release and hotfix branch names ([26261b4](https://github.com/sovantica/engrava/commit/26261b4))
* ci: cache HuggingFace models and pip to stop HF 429 (#20) ([e43f3cc](https://github.com/sovantica/engrava/commit/e43f3cc)), closes [#20](https://github.com/sovantica/engrava/issues/20)
* ci: use GitHub App token for semantic-release push to protected dev ([1a282bd](https://github.com/sovantica/engrava/commit/1a282bd))
* ci(ci): ignore merge commits in commitlint via JS config ([3d54f61](https://github.com/sovantica/engrava/commit/3d54f61))
* ci(ci): run CI on dev branch as well as main ([d28ace2](https://github.com/sovantica/engrava/commit/d28ace2))
* docs: add bi-temporal model guide and 0.3 to 0.4 upgrade notes ([036e225](https://github.com/sovantica/engrava/commit/036e225))
* docs: bring architecture + CLI docs up to 0.4.0 (bi-temporal + MCP) ([cd5df19](https://github.com/sovantica/engrava/commit/cd5df19))
* docs: capitalize the Engrava brand name in README prose ([1254830](https://github.com/sovantica/engrava/commit/1254830))
* docs: correct mindql, extensions, extension-hooks, and configuration examples ([54149ef](https://github.com/sovantica/engrava/commit/54149ef))
* docs: correct README, quickstart, and api-reference examples to match shipped API ([36cf61d](https://github.com/sovantica/engrava/commit/36cf61d))
* docs: correct reflection_boost default to 1.0; add test verifying documented config defaults ([d42a852](https://github.com/sovantica/engrava/commit/d42a852))
* docs: document percept/utterance/thought metadata helpers in api-reference ([2e80d04](https://github.com/sovantica/engrava/commit/2e80d04))
* docs: drop reference to non-existent purity-check script in CONTRIBUTING ([59dcf5d](https://github.com/sovantica/engrava/commit/59dcf5d))
* docs: expand and correct the engrava documentation set (#17) ([2c3fa82](https://github.com/sovantica/engrava/commit/2c3fa82)), closes [#17](https://github.com/sovantica/engrava/issues/17)
* docs: fix 0.4.0 drift found in the full doc audit ([bb5dff1](https://github.com/sovantica/engrava/commit/bb5dff1))
* docs: fix quickstart cycle note — remember() takes no created_cycle; use ThoughtRecord for write-sid ([8c00368](https://github.com/sovantica/engrava/commit/8c00368))
* docs: lead quickstart with remember()/recall() short path ([edfe620](https://github.com/sovantica/engrava/commit/edfe620))
* docs: lead README Basic Usage with remember()/recall() ([3f415e2](https://github.com/sovantica/engrava/commit/3f415e2))
* docs: list all installable extras in README (mcp + ollama/hf embeddings); note dreaming needs no ext ([c55f0ad](https://github.com/sovantica/engrava/commit/c55f0ad))
* docs: trim README Basic Usage to the core create-and-read example ([b2bf7bf](https://github.com/sovantica/engrava/commit/b2bf7bf))
* docs(mcp): add MCP server guide and client-config examples ([b2bc18b](https://github.com/sovantica/engrava/commit/b2bc18b))
* docs(release): align branching guide with dev release-trigger model ([7619127](https://github.com/sovantica/engrava/commit/7619127))
* docs(tests): de-reference internal principle name in doc-test rationale ([ed8b184](https://github.com/sovantica/engrava/commit/ed8b184))
* build: drop no-op 'dreaming' extra (empty deps; dreaming is in the base install) ([c6fa946](https://github.com/sovantica/engrava/commit/c6fa946))
* build(deps): raise pydantic floor to >=2.11 ([d7eaff0](https://github.com/sovantica/engrava/commit/d7eaff0))
* feat: add bi-temporal valid-time to thoughts and edges ([456bcb6](https://github.com/sovantica/engrava/commit/456bcb6))
* feat: add temporal query predicates and invalidate primitive ([86de77f](https://github.com/sovantica/engrava/commit/86de77f))
* feat: reflections inherit temporal extent from members ([8fba769](https://github.com/sovantica/engrava/commit/8fba769))
* feat(api): add remember() and recall() convenience methods on the store ([be9b110](https://github.com/sovantica/engrava/commit/be9b110))
* feat(mcp): add delete_thought and delete_edge tools ([84b87f6](https://github.com/sovantica/engrava/commit/84b87f6))
* feat(mcp): add guided memory prompts ([1f6fa36](https://github.com/sovantica/engrava/commit/1f6fa36))
* feat(mcp): add MCP server with read tools (engrava[mcp] extra) ([68a8085](https://github.com/sovantica/engrava/commit/68a8085))
* feat(mcp): add memory filters and pagination ([57357b7](https://github.com/sovantica/engrava/commit/57357b7))
* feat(mcp): add write tools, opt-in read-only mode, and per-tool safety annotations ([79d7604](https://github.com/sovantica/engrava/commit/79d7604))
* feat(mcp): expose memory as resources (thought, stats, recent) ([c54dcf7](https://github.com/sovantica/engrava/commit/c54dcf7))
* feat(mcp): map known failures to typed, actionable tool errors ([8b615cc](https://github.com/sovantica/engrava/commit/8b615cc))
* feat(mindql): add store-level execute_mindql entry point ([1c8ffb4](https://github.com/sovantica/engrava/commit/1c8ffb4))
* fix: assert plan-shape invariant for temporal queries, not scan-vs-index ([0e4e176](https://github.com/sovantica/engrava/commit/0e4e176))
* fix: embed full thought content without duplication or silent truncation ([36e08e7](https://github.com/sovantica/engrava/commit/36e08e7))
* fix: keep quoted MindQL values as strings and reject malformed conditions ([d88043d](https://github.com/sovantica/engrava/commit/d88043d))
* fix: let natural-language queries reach the full-text index ([bb6b729](https://github.com/sovantica/engrava/commit/bb6b729))
* fix: match exact table token in query-plan helpers ([cd4ecc2](https://github.com/sovantica/engrava/commit/cd4ecc2))
* fix(embeddings): retry transient errors with bounded backoff ([897c46f](https://github.com/sovantica/engrava/commit/897c46f))
* fix(mcp): keep query_memory parse errors FIND-only ([5f4ea20](https://github.com/sovantica/engrava/commit/5f4ea20))
* fix(mcp): map write-tool errors and complete the 0.4.0 documentation ([6794436](https://github.com/sovantica/engrava/commit/6794436))
* test: add documentation-example test suite ([75b977e](https://github.com/sovantica/engrava/commit/75b977e))
* test: add functional contract suite for search behavior ([862e7bc](https://github.com/sovantica/engrava/commit/862e7bc))
* test: bound temporal query overhead and confirm index use ([035e860](https://github.com/sovantica/engrava/commit/035e860))
* test: isolate subprocess examples (offline, single-thread, no stdin) ([c3cf339](https://github.com/sovantica/engrava/commit/c3cf339))
* test: pin native thread pools session-wide to stop full-suite hang ([3a0eaa3](https://github.com/sovantica/engrava/commit/3a0eaa3))
* test(docs): execute the tutorial end-to-end and a search round-trip ([730c2bb](https://github.com/sovantica/engrava/commit/730c2bb))
* perf: tune sqlite pragmas and add hot-path indexes ([1256303](https://github.com/sovantica/engrava/commit/1256303))
* chore: back-merge main into dev after v0.3.0 release ([4769d22](https://github.com/sovantica/engrava/commit/4769d22))
* chore: back-merge main into dev after v0.3.1 release ([40e45b6](https://github.com/sovantica/engrava/commit/40e45b6))
* chore(ci): switch release-trigger branch from main to dev ([cd2bb24](https://github.com/sovantica/engrava/commit/cd2bb24))
* chore(deps): bump actions/cache from 4 to 5 (#25) ([c84fb8f](https://github.com/sovantica/engrava/commit/c84fb8f)), closes [#25](https://github.com/sovantica/engrava/issues/25)
* chore(deps): bump actions/setup-python from 5 to 6 (#26) ([0a69457](https://github.com/sovantica/engrava/commit/0a69457)), closes [#26](https://github.com/sovantica/engrava/issues/26)
